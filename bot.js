...
// ==================== Password Checking ====================
        ...
        if (Jinu.JINUPW !== 'JINU' || Jinu.JINUPW !== 'JINU' || Jinu.JINUPW !== 'JINU') {
        //Coded by Shadow
        console.log(
            chalk.green.bold('✅PASSWORD DONE...\n☞ 𝙼𝚆𝙾𝙽𝚄 𝙴𝙻𝙻𝙰𝙼 𝚂𝙴𝚃𝚃𝙰𝚈𝙸𝚃𝚄𝙽𝙳...')
        );
         }
         else if (Jinu.JINUPW !== 'JINU' || Jinu.JINUPW !== 'JINU' || Jinu.JINUPW !== 'JINU') {
         console.log(
            chalk.red.bold('❌PASSWORD INCORRECT...\n☞ 𝙼𝚆𝙾𝙽𝚄 𝙴𝙻𝙻𝙰 𝙲𝙾𝙼𝙼𝙰𝙽𝙳𝚂 𝚆𝙾𝚁𝙺𝙸𝙽𝙶 𝙰𝚅𝙸𝙻𝙰...'));
         }

// ==================== End Check ====================

        console.log(
            chalk.green.bold('✅ Jinu Mwol working!')
        );
...
*/
                        try {
                            ...
                            if (config.LANG == 'TR' || config.LANG == 'AZ') {
                                ...
                                await conn.sendMessage(conn.user.jid, ' 💙ɪᴛᴢ ᴍᴇ ᴊɪɴᴜ xʀ💜 ' +
                                    '\n\n*👻 ' + error + '*\n'
                                    , MessageType.text);
                            }
                        }
